...
def setup_logger(name: str, log_level: int = logging.INFO, 
                max_file_size: int = 10 * 1024 * 1024, backup_count: int = 5) -> logging.Logger:
    """
    ...
    Args:
        ...
        max_file_size: Максимальный размер файла лога в байтах (по умолчанию 10MB)
        backup_count: Количество файлов резервных копий (по умолчанию 5)
